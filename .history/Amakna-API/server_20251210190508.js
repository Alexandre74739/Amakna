...
const personnages = [
  ...
  story: {
    titre: "Histoire",
    resume: "Quand Djaul décide de semer la zizanie...",
    sections: [
      {
        title: "Naissance de Bolgrot",
        content: "Issu d'un Dofus Turquoise pondu par Aguabrial..."
      },
      {
        title: "Le terrible dragon",
        content: "En grandissant, Bolgrot devint un terrible dragon..."
      },
      {
        title: "Post mortem",
        content: "Après sa mort, l'esprit de Bolgrot resta piégé..."
      }
    ]
  }
},
