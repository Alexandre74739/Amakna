...
const personnages = [
    ...
    },
    {
        ...
        description: `
            ...
            <p>Il propose de rendre à Tristepin ses pouvoirs — et son bras — mais celui-ci refuse pour vivre comme
            un simple mortel.</p>
            ...
            l’Inglorium avec les autres héros. Il affronte ensuite Rasha, le frère de Rushu.</p>

            <h3>Dans l'Inglorium</h3>
            <p>Il accepte une trêve avec Adamaï et part aider à sauver le jeune Pin, possédé par Rasha. Grâce à
            l’intervention d’Evangelyne, Pin reprend le contrôle.</p>
