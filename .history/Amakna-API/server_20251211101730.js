...
const personnages = [
    ...
    { 
        ...
        noire des écailles du dragon. Orphelin, il fut confié à Kerubim Crépin, ami proche de Jahash.
        </p>

        <h3>Dofus : Aux Trésors de Kerubim</h3>
        <p>
        Joris grandit à Astrub, enfant dégourdi admirant son père adoptif Kerubim, célèbre brocanteur et aventurier,
        dont il écoute avec passion les récits.
        </p>

        <h3>Dofus, Livre I : Julith</h3>
        <p>
        Après avoir déménagé à Bonta, Joris s'apprête à assister à un match de Boufbowl pour rencontrer son idole,
        ...
        par Julith et autrefois gardé par Kerubim.
        </p>

        <h3>Dofus - Welsh et Sheddar</h3>
        <p>
        Joris aide Welsh à récupérer le trône de Bonta. En récompense, il est nommé ambassadeur.
        </p>

        <h3>Wakfu – La série</h3>
        <p>
        Durant les événements de Wakfu, Joris est toujours ambassadeur de Bonta. Il se rend plusieurs fois
        au Royaume Sadida pour des affaires diplomatiques et y aide à de nombreuses reprises la Confrérie du Tofu.
        </p>

        <h3>Manga Wakfu</h3>
        <p>
        Joris s'oppose à Jiva lorsque celle-ci attaque la Confrérie du Tofu lors de l'anniversaire de Yugo et Adamaï.
        Bien qu'il l'interroge sur les raisons de sa colère, la protectrice de Javian le neutralise sans difficulté.</p>

        <p>Après avoir vaincu la Confrérie et tué Phaéris, Jiva prend Chibi et Grougaloragran en otage et exige les six
